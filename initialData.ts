  ...
  "works": [
    {
      ...
      "featuredOrder": 1,
      "views": 0,
      "description": "tentáculos mundanos descontrolados\ncombatemos com o fluxo do agora\namígdala, centro de tudo\nfluido, o meio\nondas ressoam\nenquanto a palavra é falha\neu dissolvo\n\nsilêncio surge\nem estados de alteração contínua\n\nobservo\n\ne recomeça",
      "seoDescription": "enquanto a palavra falha, eu dissolvo"
    },
    {
    ...
    },
    {
      ...
      "technique": "óleo sobre tela",
      "dimensions": "20x15 cm",
      "imageUrl": "https://res.cloudinary.com/dcxm8yd49/image/upload/v1780018250/surrealist-portrait-sky-checkerboard-painting_bulxg6.avif",
      "status": "disponível",
      "isVisible": true,
      "isFeatured": true,
      "featuredOrder": 0,
  ...
  "signals": [
    {
      ...
      "status": "publicado",
      "views": 4,
      "coverImageUrl": "https://res.cloudinary.com/dcxm8yd49/image/upload/v1783465432/transmutacao.png",
      ...
      "layers": [
        ...
        },
        {
          ...
          "lines": [
            ...
            [
              ...
              {
                "t": "matéria em reorganização",
                "accent": true
              }
            ],
            [
              {
                "t": "quarks, léptons, particulas"
              }
            ],
            [
              {
        ...
        },
        {
          ...
          "lines": [
            ...
            [
              {
                "t": "nos limitando os sentidos frente à "
              },
              {
                "t": "transitoriedade",
                "accent": true
            ...
            [
              {
                "t": "projetamos cenários para suportar o "
              },
              {
                "t": "indeterminado",
                "accent": true
        ...
        },
        {
          ...
          "lines": [
            ...
            [
              ...
              {
                "t": "desconformidade controlada",
                "accent": true
              }
            ],
            [
              {
                "t": "negociando constantemente com a tendência ao "
              },
              {
                "t": "caos",
                "accent": true
        ...
        },
        {
          ...
          "lines": [
            [
              {
                "t": "e é nessa fenda que observo os "
              },
              {
                "t": "ruídos",
                "accent": true
