          ...
          <div className="lg:col-span-8 w-full flex justify-center">
            ...
            >
              <motion.img 
                ...
                className="max-w-full max-h-[75vh] object-contain transition-all duration-500 filter drop-shadow-[0_15px_25px_rgba(0,0,0,0.65)] group-hover:drop-shadow-[0_20px_45px_rgba(var(--accent-rgb),0.35)]"
